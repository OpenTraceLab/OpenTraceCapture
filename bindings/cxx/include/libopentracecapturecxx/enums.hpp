...
/** Log verbosity level */
class OTC_API LogLevel : public EnumValue<LogLevel, enum otc_loglevel>
{
public:
...
protected:
    LogLevel(enum otc_loglevel id, const char name[]) : EnumValue(id, name) {}
...
template<> const OTC_API std::map<const enum otc_datatype, const DataType * const> EnumValue<DataType, enum otc_datatype>::_values;

/** Configuration data type */
class OTC_API DataType : public EnumValue<DataType, enum otc_datatype>
{
public:
...
protected:
    DataType(enum otc_datatype id, const char name[]) : EnumValue(id, name) {}
...
template<> const OTC_API std::map<const enum otc_packettype, const PacketType * const> EnumValue<PacketType, enum otc_packettype>::_values;

/** Type of datafeed packet */
class OTC_API PacketType : public EnumValue<PacketType, enum otc_packettype>
{
public:
...
protected:
    PacketType(enum otc_packettype id, const char name[]) : EnumValue(id, name) {}
...
template<> const OTC_API std::map<const enum otc_mq, const Quantity * const> EnumValue<Quantity, enum otc_mq>::_values;

/** Measured quantity */
class OTC_API Quantity : public EnumValue<Quantity, enum otc_mq>
{
public:
...
protected:
    Quantity(enum otc_mq id, const char name[]) : EnumValue(id, name) {}
...
template<> const OTC_API std::map<const enum otc_unit, const Unit * const> EnumValue<Unit, enum otc_unit>::_values;

/** Unit of measurement */
class OTC_API Unit : public EnumValue<Unit, enum otc_unit>
{
public:
	...
	/** Mass in dram [dr]. */
	static const Unit * const DRAM;
	/** Area density in g/m^2. */
	static const Unit * const GRAMMAGE;

protected:
    Unit(enum otc_unit id, const char name[]) : EnumValue(id, name) {}
	...
	static const Unit _DRAM;
	static const Unit _GRAMMAGE;
};

template<> const OTC_API std::map<const enum otc_mqflag, const QuantityFlag * const> EnumValue<QuantityFlag, enum otc_mqflag>::_values;

/** Flag applied to measured quantity */
class OTC_API QuantityFlag : public EnumValue<QuantityFlag, enum otc_mqflag>
{
public:
	...
	static const QuantityFlag * const TAEL_TAIWAN;
	/** Tael measurement (Hong Kong/Troy variant, 37.43 g/tael). */
	static const QuantityFlag * const TAEL_HONGKONG_TROY;
	/** Tael measurement (Japan variant, 37.80 g/tael). */
	static const QuantityFlag * const TAEL_JAPAN;
...
protected:
    QuantityFlag(enum otc_mqflag id, const char name[]) : EnumValue(id, name) {}
	...
	static const QuantityFlag _TAEL_TAIWAN;
	static const QuantityFlag _TAEL_HONGKONG_TROY;
	static const QuantityFlag _TAEL_JAPAN;
};

template<> const OTC_API std::map<const enum otc_trigger_matches, const TriggerMatchType * const> EnumValue<TriggerMatchType, enum otc_trigger_matches>::_values;

/** Trigger match type */
class OTC_API TriggerMatchType : public EnumValue<TriggerMatchType, enum otc_trigger_matches>
{
public:
...
protected:
    TriggerMatchType(enum otc_trigger_matches id, const char name[]) : EnumValue(id, name) {}
...
template<> const OTC_API std::map<const enum otc_output_flag, const OutputFlag * const> EnumValue<OutputFlag, enum otc_output_flag>::_values;

/** Flag applied to output modules */
class OTC_API OutputFlag : public EnumValue<OutputFlag, enum otc_output_flag>
{
public:
...
protected:
    OutputFlag(enum otc_output_flag id, const char name[]) : EnumValue(id, name) {}

	static const OutputFlag _INTERNAL_IO_HANDLING;
};

template<> const OTC_API std::map<const enum otc_channeltype, const ChannelType * const> EnumValue<ChannelType, enum otc_channeltype>::_values;

/** Channel type */
class OTC_API ChannelType : public EnumValue<ChannelType, enum otc_channeltype>
{
public:
...
protected:
    ChannelType(enum otc_channeltype id, const char name[]) : EnumValue(id, name) {}

	static const ChannelType _LOGIC;
	static const ChannelType _ANALOG;
};

template<> const OTC_API std::map<const enum otc_configcap, const Capability * const> EnumValue<Capability, enum otc_configcap>::_values;

/** Configuration capability */
class OTC_API Capability : public EnumValue<Capability, enum otc_configcap>
{
public:
...
protected:
    Capability(enum otc_configcap id, const char name[]) : EnumValue(id, name) {}
...
template<> const OTC_API std::map<const enum otc_configkey, const ConfigKey * const> EnumValue<ConfigKey, enum otc_configkey>::_values;

/** Configuration key */
class OTC_API ConfigKey : public EnumValue<ConfigKey, enum otc_configkey>
{
public:
...
protected:
    ConfigKey(enum otc_configkey id, const char name[]) : EnumValue(id, name) {}
