...
#define WANT_OPENTRACECAPTURE_GIT_VERSION_H
 ...
 * to libopentracecapture. The "package version" is the release version number of the
 * libopentracecapture tarball in the usual "major.minor.micro" format, e.g. "0.1.0".
 *
...
/**
 * Get the major libopentracecapture package version number.
 *
...
{
	return OTC_PACKAGE_VERSION_MAJOR;
}

/**
 * Get the minor libopentracecapture package version number.
 *
...
{
	return OTC_PACKAGE_VERSION_MINOR;
}

/**
 * Get the micro libopentracecapture package version number.
 *
...
{
	return OTC_PACKAGE_VERSION_MICRO;
}

/**
 * Get the libopentracecapture package version number as a string.
 *
...
{
	return OTC_PACKAGE_VERSION_STRING;
}

/**
 * Get the "current" part of the libopentracecapture library version number.
 *
...
{
	return OTC_LIB_VERSION_CURRENT;
}

/**
 * Get the "revision" part of the libopentracecapture library version number.
 *
...
{
	return OTC_LIB_VERSION_REVISION;
}

/**
 * Get the "age" part of the libopentracecapture library version number.
 *
...
{
	return OTC_LIB_VERSION_AGE;
}

/**
 * Get the libopentracecapture library version number as a string.
 *
