...
static struct otc_dev_driver scpi_dmm_driver_info;
...
static const struct mqopt_item mqopts_agilent_34405a[] = {
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_DC, "VOLT:DC", "VOLT ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_AC, "VOLT:AC", "VOLT:AC ", NO_DFLT_PREC, FLAG_CONF_DELAY | FLAG_MEAS_DELAY, },
	{ OTC_MQ_CURRENT, OTC_MQFLAG_DC, "CURR:DC", "CURR ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CURRENT, OTC_MQFLAG_AC, "CURR:AC", "CURR:AC ", NO_DFLT_PREC, FLAG_CONF_DELAY | FLAG_MEAS_DELAY, },
	{ OTC_MQ_RESISTANCE, 0, "RES", "RES ", NO_DFLT_PREC, FLAG_MEAS_DELAY, },
	{ OTC_MQ_RESISTANCE, OTC_MQFLAG_FOUR_WIRE, "FRES", "FRES ", NO_DFLT_PREC, FLAG_MEAS_DELAY, },
	{ OTC_MQ_CONTINUITY, 0, "CONT", "CONT", -1, FLAG_NO_RANGE, },
	{ OTC_MQ_CAPACITANCE, 0, "CAP", "CAP ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_DC | OTC_MQFLAG_DIODE, "DIOD", "DIOD", -4, FLAG_NO_RANGE, },
	{ OTC_MQ_TEMPERATURE, 0, "TEMP", "TEMP ", NO_DFLT_PREC, FLAG_NO_RANGE | FLAG_MEAS_DELAY, },
	{ OTC_MQ_FREQUENCY, 0, "FREQ", "FREQ ", NO_DFLT_PREC, FLAG_NO_RANGE | FLAG_MEAS_DELAY, },
};

static const struct mqopt_item mqopts_agilent_34401a[] = {
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_DC, "VOLT:DC", "VOLT ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_AC, "VOLT:AC", "VOLT:AC ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CURRENT, OTC_MQFLAG_DC, "CURR:DC", "CURR ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CURRENT, OTC_MQFLAG_AC, "CURR:AC", "CURR:AC ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_RESISTANCE, 0, "RES", "RES ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_RESISTANCE, OTC_MQFLAG_FOUR_WIRE, "FRES", "FRES ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CONTINUITY, 0, "CONT", "CONT", -1, FLAGS_NONE, },
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_DC | OTC_MQFLAG_DIODE, "DIOD", "DIOD", -4, FLAGS_NONE, },
	{ OTC_MQ_FREQUENCY, 0, "FREQ", "FREQ ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_TIME, 0, "PER", "PER ", NO_DFLT_PREC, FLAGS_NONE, },
};

static const struct mqopt_item mqopts_gwinstek_gdm8200a[] = {
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_DC, "VOLT:DC", "01", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_AC, "VOLT:AC", "02", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CURRENT, OTC_MQFLAG_DC, "CURR:DC", "03", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CURRENT, OTC_MQFLAG_AC, "CURR:AC", "04", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CURRENT, OTC_MQFLAG_DC, "CURR:DC", "05", NO_DFLT_PREC, FLAGS_NONE, }, /* mA */
	{ OTC_MQ_CURRENT, OTC_MQFLAG_AC, "CURR:AC", "06", NO_DFLT_PREC, FLAGS_NONE, }, /* mA */
	{ OTC_MQ_RESISTANCE, 0, "RES", "07", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_RESISTANCE, OTC_MQFLAG_FOUR_WIRE, "FRES", "16", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CONTINUITY, 0, "CONT", "13", -1, FLAGS_NONE, },
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_DC | OTC_MQFLAG_DIODE, "DIOD", "17", -4, FLAGS_NONE, },
	{ OTC_MQ_TEMPERATURE, 0, "TEMP", "09", NO_DFLT_PREC, FLAGS_NONE, }, /* Celsius */
	{ OTC_MQ_TEMPERATURE, 0, "TEMP", "15", NO_DFLT_PREC, FLAGS_NONE, }, /* Fahrenheit */
	{ OTC_MQ_FREQUENCY, 0, "FREQ", "08", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_TIME, 0, "PER", "14", NO_DFLT_PREC, FLAGS_NONE, },
};
...
static const struct mqopt_item mqopts_gwinstek_gdm906x[] = {
	...
	{ OTC_MQ_CONTINUITY, 0, "CONT", "CONT", -1, FLAGS_NONE, },
	{ OTC_MQ_VOLTAGE, OTC_MQFLAG_DC | OTC_MQFLAG_DIODE, "DIOD", "DIOD", -4, FLAGS_NONE, },
	{ OTC_MQ_TEMPERATURE, 0, "TEMP", "TEMP", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_FREQUENCY, 0, "FREQ", "FREQ", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_TIME, 0, "PER", "PER", NO_DFLT_PREC, FLAGS_NONE, },
	{ OTC_MQ_CAPACITANCE, 0, "CAP", "CAP", NO_DFLT_PREC, FLAGS_NONE, },
};
...
OTC_PRIV const struct scpi_dmm_model models[] = {
	{
		"Agilent", "34405A",
 ...
 */
static gboolean probe_opc_support(struct otc_scpi_dev_inst *scpi)
{
	gboolean result;
	GString *response;
	...
	result = TRUE;
	if (otc_scpi_get_data(scpi, SCPI_CMD_OPC, &response) != OTC_OK)
		result = FALSE;
...
static struct otc_dev_inst *probe_device(struct otc_scpi_dev_inst *scpi)
{
	 ...
	 */
	command = otc_scpi_cmd_get(devc->cmdset, DMM_CMD_SETUP_LOCAL);
	if (command && *command) {
...
static int dev_close(struct otc_dev_inst *sdi)
{
	...
	otc_dbg("DIAG: sdi->status %d.", sdi->status - OTC_ST_NOT_FOUND);
...
static int dev_acquisition_start(const struct otc_dev_inst *sdi)
{
	 ...
	 */
	command = otc_scpi_cmd_get(devc->cmdset, DMM_CMD_QUERY_PREC);
	if (command && *command) {
		scpi_dmm_cmd_delay(scpi);
		...
		if (ret == OTC_OK) {
			...
			g_free(response);
			otc_dbg("%s: Precision: '%s'", __func__, devc->precision);
		} else {
			otc_info("Precision query ('%s') failed: %d",
				command, ret);
		}
	}

	command = otc_scpi_cmd_get(devc->cmdset, DMM_CMD_START_ACQ);
	if (command && *command) {
		scpi_dmm_cmd_delay(scpi);
		ret = otc_scpi_send(scpi, command);
		if (ret != OTC_OK)
			return ret;
	}
...
static int dev_acquisition_stop(struct otc_dev_inst *sdi)
{
	...
	command = otc_scpi_cmd_get(devc->cmdset, DMM_CMD_STOP_ACQ);
	if (command && *command) {
		scpi_dmm_cmd_delay(scpi);
		(void)otc_scpi_send(scpi, command);
	}
...
OTC_REGISTER_DEV_DRIVER(scpi_dmm_driver_info);
