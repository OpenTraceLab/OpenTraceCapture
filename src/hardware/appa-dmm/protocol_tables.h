...
#ifndef LIBOPENTRACECAPTURE_HARDWARE_APPA_DMM_PROTOCOL_TABLES_H
#define LIBOPENTRACECAPTURE_HARDWARE_APPA_DMM_PROTOCOL_TABLES_H
...
#endif/*LIBOPENTRACECAPTURE_HARDWARE_APPA_DMM_PROTOCOL_TABLES_H*/
